            ...
            <Container>
                <div className={styles.contact_body}>
                    <div className={styles.contact_content}>
                        <h2 className={styles.contact_content_title}>Мы всегда вам рады</h2>
                        <div className={styles.contact_content_item}>
                            <h4 className={styles.contact_content_item_title}>Приём заказов:</h4>
                            <p className={styles.contact_content_item_subtitle}>+7702 777 77 77</p>
                        </div>
                        <div className={styles.contact_content_item}>
                            <h4 className={styles.contact_content_item_title}>Приходите к нам:</h4>
